...
public class FUManager {
    ...
    public static void renderItemsToYUVFrame(final byte[] yBuffer, final byte[] uBuffer, final byte[] vBuffer, final int yStride, final int uStride, final int vStride, final int w, final int h, final int rotation) {
        if (context == null) {
            return;
        }
